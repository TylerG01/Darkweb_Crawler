...
CREATE TABLE IF NOT EXISTS silver (
    ...
    common_word_5 VARCHAR(255),
    FOREIGN KEY (bronze_id) REFERENCES bronze(id)
);
"""

external_link_columns = ",\n".join([f"External_Link_{i} TEXT" for i in range(1, 20)])
...
def create_tables(cursor):
    tables = {
        ...
        "removed": create_removed_table_query,
        "random": create_random_table_query 
    }
